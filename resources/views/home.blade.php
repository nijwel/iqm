...
@php
  $users = App\Models\User::where('user_type',2)->count();
  $brands = App\Models\Admin\Category::count();
  $products = App\Models\Admin\Product::count();
  $models = App\Models\Admin\SubCategory::count();
  $buying_price = App\Models\Admin\Product::sum('buying_price');
  $product_value = App\Models\Admin\Product::sum('stock_value');
  $retail = App\Models\Admin\Product::sum('retail_price');
  $wholesale = App\Models\Admin\Product::sum('whole_sale');
          ...
          <div class="col-xl-12">
            ...
            <div class="card">
              <div class="card-header header-elements-inline">
                <h6 class="card-title">Data Statics</h6>
                ...
                <div class="row">
                  <div class="col-sm-3">
                    <div class="d-flex align-items-center justify-content-center mb-2">
                      ...
                      <div>
                        <div class="font-weight-semibold">Total Brands</div>
                  ...
                  <div class="col-sm-3">
                    <div class="d-flex align-items-center justify-content-center mb-2">
                      ...
                      <div>
                        <div class="font-weight-semibold">Total Models</div>
                  ...
                  <div class="col-sm-3">
                    <div class="d-flex align-items-center justify-content-center mb-2">
                      ...
                      <div>
                        <div class="font-weight-semibold">Total Products</div>
                  ...
                  <div class="col-sm-3">
                    <div class="d-flex align-items-center justify-content-center mb-2">
                      ...
                      <div>
                        ...
                        <span class="text-muted"><span class="badge badge-mark border-success mr-2"></span> {{ $users }}</span>
                      </div>
                    </div>
                ...
                <div class="row">
                  <div class="col-sm-3">
                    <div class="d-flex align-items-center justify-content-center mb-2">
                      ...
                      <div>
                        <div class="font-weight-semibold">Total Costing</div>
                        <span class="text-muted"><span class="badge badge-mark border-success mr-2"></span> {{ $buying_price }}</span>
                      </div>
                    </div>
                    {{-- <div class="w-75 mx-auto mb-3" id="total-online"></div> --}}
                  </div>
                  ...
                  <div class="col-sm-3">
                    <div class="d-flex align-items-center justify-content-center mb-2">
                      ...
                      <div>
                        <div class="font-weight-semibold">Total Retail Price</div>
                  ...
                  <div class="col-sm-3">
                    <div class="d-flex align-items-center justify-content-center mb-2">
                      ...
                      <div>
                        <div class="font-weight-semibold">Total Wholesale Price</div>
                  ...
                  <div class="col-sm-3">
                    <div class="d-flex align-items-center justify-content-center mb-2">
                      ...
                      <div>
                        <div class="font-weight-semibold">Total Value</div>
                        <span class="text-muted"><span class="badge badge-mark border-success mr-2"></span> {{ $product_value }}</span>
                      </div>
                    </div>
                    <!--<div class="w-75 mx-auto mb-3" id="total-online"></div>-->
                  </div>
