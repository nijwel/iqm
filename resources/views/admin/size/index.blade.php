...
@section('content')
	...
	<div class="page-header page-header-light">
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Datatables</span> - Size</h4>
				<a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
			</div>
			<div class="header-elements d-none">
				<div class="d-flex justify-content-center">
					<a href="#" class="btn btn-link btn-float text-default"><span>Statistics</span></a>
					<a href="#" class="btn btn-link btn-float text-default"> <span>Invoices</span></a>
					<a href="#" class="btn btn-link btn-float text-default"> <span>Schedule</span></a>
				</div>
			</div>
		</div>
	...
	<div class="content">
		...
		<div class="card">
			...
			<form action="{{ route('size.multi.delete') }}" method="post" id="multi_delete">
				@csrf
			<table class="table datatable-responsive" id="datatable">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							@if($row->status == 1)
							<a href="{{ route('active.size',$row->id) }}"><span class="badge badge-success">Active</span></a>
							@else
							<a href="{{ route('deactive.size',$row->id) }}"><span class="badge badge-danger">Deactive</span></a>
							@endif
						</td>
							...
							<div class="list-icons">
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right">
										...
										<a href="{{ route('delete.size',$row->id) }}" id="delete" class="dropdown-item"><i class="icon-bin"></i> Delete</a>
									</div>
								</div>
							</div>
						</td>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h3 class="modal-title">Add Size</h3>
						<button type="button" class="close" data-dismiss="modal">&times;</button>
					</div>

					<div class="modal-body">
						<form class="form-validate" action="{{ route('store.size') }}" method="post" id="add_form">
							@csrf
							<fieldset class="mb-3">
								<!-- Basic text input -->
		...
		<div id="editModal" class="modal fade" tabindex="-1">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h3 class="modal-title">Edit Size</h3>
						<button type="button" class="close" data-dismiss="modal">&times;</button>
					</div>
