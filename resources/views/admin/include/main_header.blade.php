            ...
            <ul class="navbar-nav">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-content wmin-md-300">
                        ...
                        <div class="dropdown-content-body dropdown-scrollable">
                            <ul class="media-list">
                                <li class="media">
                                    <div class="mr-3">
                                        <img src="{{ asset('public/backend/global_assets/images/demo/users/face18.jpg') }}" width="36" height="36" class="rounded-circle" alt="">
                                    </div>
                                    <div class="media-body">
                ...
                <li class="nav-item dropdown dropdown-user">
                    <a href="#" class="navbar-nav-link d-flex align-items-center dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ asset('public/backend/') }}/images/logo.png" class="rounded-circle mr-2" height="34" alt="">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a href="{{ route('password') }}" class="dropdown-item"><i class="icon-cog5"></i> Account settings</a>
