							...
							<div class="list-icons">
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right">
										...
										<a href="{{ route('delete.amount.paid',$row->id) }}" id="delete" class="dropdown-item"><i class="icon-bin"></i> Delete</a>
									</div>
								</div>
							</div>
						</td>
								...
								<div class="row">
									<div class="form-group col-lg-8 mt-2">
										<label class="form-group-lebel">Customer Name <span class="text-danger">*</span></label>
											<select name="customer_id" class="form-control customer_id select22" style="width: 100%" id="customer_id" required>
									...
									<div class="form-group col-lg-4">
										...
										<input type="number" name="amount" min="0" step="any" value="{{ old('amount') }}" class="form-control" required placeholder="Amount">
									</div>
								</div>
								<!-- /basic text input -->
							</fieldset>
