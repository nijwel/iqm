	...
	<div class="page-header page-header-light">
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Model</span> - List</h4>
			...
			<table class="table datatable-responsive" id="datatable">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							@if($row->status == 1)
							<a href="{{ route('active.sub_category',$row->id) }}"><span class="badge badge-success">Active</span></a>
							@else
							<a href="{{ route('deactive.sub_category',$row->id) }}"><span class="badge badge-danger">Deactive</span></a>
							@endif
						</td>
						<td class="text-center" width="120">
							...
							<!--			<a href="{{ route('delete.sub_category',$row->id) }}" id="delete" class="dropdown-item"><i class="icon-bin"></i> Delete</a>-->
							<!--		</div>-->
							<!--	</div>-->
							<!--</div>-->
							
							<a href="#" class="badge badge-info edit" data-id="{{ $row->id }}" data-toggle="modal" data-target="#editModal"> Edit</a>
							<a href="{{ route('delete.sub_category',$row->id) }}" id="delete" class="badge badge-danger"> Delete</a>
						</td>
					</tr>
					@empty
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form-validate" action="{{ route('store.sub_category') }}" method="post" id="add_form">
							@csrf
							<fieldset class="mb-3">
								<!-- Basic text input -->
								<div class="form-group row">
									...
									<div class="col-lg-12">
										<select name="category_id" class="form-control select22" style="width: 100%" id="category">
								...
								<div class="form-group row">
									...
									<div class="col-lg-12">
										<input type="text" name="subcategory" class="form-control" id="subcategory" placeholder="Model name">
									</div>
									<strong class="text-danger category" ></strong>
								</div>
								<!-- /basic text input -->
