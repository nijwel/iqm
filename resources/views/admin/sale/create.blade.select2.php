    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        ...
        <div class="header-elements d-none">
            <div class="breadcrumb justify-content-center">
                <a href="{{ route('index.product.sale.' . ($shop == 'kkm' ? 'kkm' : ($shop == 'mn' ? 'nm' : 'iqm'))) }}"
                ...
                <table class="table" id="dynamic_field">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input type="number" name="item_total_price[]" class="form-control item_total_price"
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="3"></td>
                            <td>
                                <input type="text" id="total" name="total_price" class="form-control total" readonly>
                            </td>
                        </tr>
                    </tfoot>
                </table>
...
$('.add').click(function() {
    ...
    const newRow = `
            <tr>
                ...
                <td><input type='number' class='form-control item_price' name='item_price[]' required placeholder='0.00' min='0'></td>
                <td><input type='number' class='form-control item_qty' name='item_qty[]' required value='1' min='1'></td>
                <td><input type='number' class='form-control item_total_price' name='item_total_price[]' readonly></td>
